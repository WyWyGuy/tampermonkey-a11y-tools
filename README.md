...
1. Add the Tampermonkey Chrome extension: [Chrome Extension - Tampermonkey](https://chromewebstore.google.com/detail/tampermonkey/dhdgffkkebhmkfjojejmpbldmpobfkfo?pli=1)
...
7. Click the **Settings** tab in the upper-right corner.
8. Check **Update disabled scripts**.
9. Set the check interval to **Every Day**.
10. Set the update interval of **Externals** to **Every Day**.

### Installing a Script

1. Click the name of a script on this GitHub page.
2. Click the **Raw** button above the code.
3. Click **Install**.
...
This script has been deprecated, as its functionality has been incorporated into `RawHTMLEditorHelper.user.js`.
